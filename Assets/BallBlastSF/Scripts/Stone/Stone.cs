...
public class Stone : Distractable
{

    [SerializeField] public Coins coins;
    public enum Size
    {
        Small,
        Normal,
    ...
    private void OnStoneDestroyed()
    {
        ...
        {
            SpawnStones();
            coins.CoinsSpawn(this.transform.position);
        }
    ...
    private void SpawnStones()
    {
        for (int i = 0; i < 2; i++)
        {
            ...
            stone.movement.AddVerticalVelosity(spawnUpForce);
